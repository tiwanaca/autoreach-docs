...
The search returns up to 3 candidate accounts with follower counts and audience categories. Select which to save, then use them as seed accounts for extraction via the "From a Lookalike" option.
