...
| --------------------- | - | -------- | ------------------------------------ |
| **Send DM**           | Y | Y        | Direct message                       |
| **Like Post**         | Y | Y        | Like a post                          |
| **Reply/Comment**     | Y | Y        | Reply to a post                      |
| **Follow/Connect**    | Y | Y        | Follow on X; connect on LinkedIn     |
| **View Profile**      | - | Y        | View a profile (LinkedIn only)       |
| **Remove Connection** | - | Y        | Remove connection (LinkedIn only)    |
...
Visit a lead's profile on LinkedIn. A subtle signal of interest; useful for research or to trigger profile notifications.
...
Remove a connection on LinkedIn. Useful for cleaning up non-responders and keeping your network focused.
...
| **In Progress** | Being executed (usually less than 1 second)                                      |
