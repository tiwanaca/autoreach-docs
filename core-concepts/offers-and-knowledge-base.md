...
An **offer** is the foundation of everything in AutoReach. It's not just a description of your product—it's the intelligence engine that powers lead discovery, scoring, personalization, and AI responses.
...
{% hint style="info" %}
**Pro Tip:** Spend time defining your offer well. A great offer definition is a force multiplier—it makes every downstream feature smarter.
{% endhint %}
...
Tone examples get 500 tokens of the 1100-token total context budget. If you have 30 tone examples, AutoReach will intelligently retrieve the most relevant 2-3 examples for each situation.
...
3. **Suggests improvements** for:
   ...
   - Pain point focus (emphasize X pain point more)
...
{% hint style="warning" %}
**Leads Can Match Multiple Offers:** If a lead fits both Offer 1 and Offer 2, they'll appear in both pipelines. This is intentional—different offers might have different sales approaches to the same person.
{% endhint %}

## Best Practices

{% hint style="info" %}
**Start Specific:** A narrow, well-defined offer (yoga for busy parents aged 30-45) scores better than broad offers (fitness for everyone). Specific signals → specific discovery → higher-quality leads.
{% endhint %}
...
{% hint style="info" %}
**Knowledge Base is Optional But Powerful:** You can run AutoReach without a knowledge base, but uploads your best docs if you want AI responses to be more sophisticated and on-brand.
{% endhint %}

{% hint style="warning" %}
**Don't Overload Knowledge Base:** Uploading 200-page documents doesn't help. Upload 5-10 high-quality docs instead. Longer isn't smarter—relevance is.
{% endhint %}
