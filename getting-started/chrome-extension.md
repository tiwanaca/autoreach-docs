...
2. Paste your **License Key** (found at [autoreach.tech/settings/integrations](https://autoreach.tech/settings/integrations))
3. Click **Activate**
...
Manage your sales pipeline directly from the browser. As you browse LinkedIn, you can:

* **Create leads**: See a prospect's profile? Click "Add to Leads" to add them to your CRM.
* **Track pipeline stage**: Move leads automatically through your sales funnel (new > requested > accepted > contacted > replied > meeting > won/lost).
