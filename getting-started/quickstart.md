...
- **Calendly**: Requires a paid Calendly subscription. Add your booking link, click next, and when prompted for the webhook, follow the instructions to get the auth token and enable all scopes. See [Meetings](../meetings/meetings.md) for details.
