...
Here's the typical cost breakdown for a lead flowing through AutoReach:
...
- Can be disabled if you don't need rich company context

**Medium Cost: Profile Discovery**
- Finding cross-platform profiles (LinkedIn ↔ Twitter)
...
If you don't need deep company analysis, disable web enrichment in your discovery settings. This cuts enrichment cost roughly 40-50%.
...
| LinkedIn Enrichment | ~$1.50 | 100 × $0.015 |
| Web Enrichment | ~$8 | 100 × $0.08 |
