...
- **replied** — they've engaged with your outreach
...
This means you don't have to manually track who's accepted—it's all automatic.

{% hint style="success" %}
Fuzzy matching is smart enough to handle common name variations, misspellings, and nickname differences, so connections are linked accurately even if the name isn't exact.
{% endhint %}
...
{% hint style="warning" %}
Be cautious with flagged profiles. Don't accept connection requests or share sensitive information with accounts that trigger security warnings.
{% endhint %}
...
**This means:**
- You see at a glance which AutoReach leads match the profiles you're viewing
...
Each lead shows which sequences they're enrolled in, visible in the extension sidebar.
...
{% hint style="tip" %}
Use active sequence tracking to avoid duplicate outreach. If a lead is in multiple sequences, you'll see it in the extension.
{% endhint %}

## Real-Time Messaging Overlay

When you're chatting with someone on LinkedIn or X, a lightweight messaging overlay appears showing:
...
This keeps relevant context visible while you're actually in the conversation.

{% hint style="info" %}
The messaging overlay is lightweight and doesn't interfere with normal LinkedIn/X messaging. You can minimize or close it anytime.
{% endhint %}
...
5. You're connected—the extension can now send messages and track activity
...
{% hint style="success" %}
Install the extension and pin it to your toolbar for quick access. It's designed to fit seamlessly into your workflow without slowing you down.
{% endhint %}
